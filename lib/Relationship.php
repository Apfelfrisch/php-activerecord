...
class HasMany extends AbstractRelationship
{
	...
	public function load_eagerly(array $models, array $attributes, $includes, Table $table)
	{
...
class BelongsTo extends AbstractRelationship
{
	...
	public function load_eagerly(array $models, $attributes, $includes, Table $table)
	{
